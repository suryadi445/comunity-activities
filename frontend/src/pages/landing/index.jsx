...
export default function Landing() {
    ...
    */
    ...
    useEffect(() => {
        const interval = setInterval(() => setTime(new Date()), 1000000);
        ...
        <>
            <main className="bg-gray-50 min-h-screen text-gray-900 font-sans">
                ...
                <section className="relative w-full h-screen overflow-hidden select-none">
                    {/* Slideshow */}
                    {landingData &&
                        landingData.slideshow &&
                        Array.isArray(landingData.slideshow) &&
                        landingData.slideshow.map((slide, index) => (
                            <div
                                key={index}
                                ...
                                <div className="absolute inset-0 bg-black/70 flex flex-col justify-center items-center text-center px-6 md:px-12">
                                    ...
                                    <div className="flex gap-4 mt-8">
                                        <button
                                            ...
                                            className="inline-block px-8 py-3 rounded-full font-semibold text-lg text-indigo-600 bg-white hover:bg-indigo-50 hover:scale-105 hover:shadow-lg transition-all duration-300 ease-in-out"
                                        >
                                            Login
                                        </button>
                                        <button
                                            ...
                                            className="inline-block px-8 py-3 rounded-full font-semibold text-lg text-white bg-indigo-600 hover:bg-indigo-700 hover:scale-105 hover:shadow-lg focus:ring-4 focus:ring-indigo-300 dark:bg-indigo-600 dark:hover:bg-indigo-800 dark:focus:ring-indigo-900 transition-all duration-300 ease-in-out"
                                        >
                                            Register
                                        </button>
                                    </div>
                    ...
                    {/* Dots Navigasi (nempel di bawah gambar) */}
                    {landingData &&
                        landingData.slideshow &&
                        Array.isArray(landingData.slideshow) && (
                            <div className="absolute bottom-0 left-0 w-full flex justify-center pb-6 pt-4 bg-gradient-to-t from-black/60 to-transparent z-20">
                                {landingData.slideshow.map((_, index) => (
                                    <button
                                        key={index}
                                        onClick={() => setCurrent(index)}
                                        className={`w-4 h-4 mx-2 rounded-full border-2 border-indigo-400 ${index === current ? "bg-indigo-400" : "bg-transparent"
                    ...
                    <div className="container mx-auto px-6">
                        ...
                        <div className="flex flex-col lg:flex-row items-center gap-12 bg-white rounded-2xl shadow-xl p-8 lg:p-12">
                            <div className="lg:w-1/2 w-full text-center lg:text-left">
                                ...
                                <ul className="space-y-4 text-gray-100 text-lg text-left inline-block lg:inline-block">
            ...
            >
                <form onSubmit={handleLoginSubmit} className="space-y-4">
                    <div>
                        ...
                        <TextInput id="email" type="email" placeholder="you@example.com" name="email" value={loginForm.email} onChange={(e) => setLoginForm({ ...loginForm, email: e.target.value })} required />
                    </div>
                    <div>
                    ...
                    <button type="submit" className="w-full bg-indigo-600 text-white rounded-lg py-2 hover:bg-indigo-700 transition-colors">
